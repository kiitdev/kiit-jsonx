 ...
 *
 * Node names cosmetically mirror `kotlinx.serialization.json.JsonElement`. There's no functional
 * relationship or dependency between the two.
 *
...
sealed class JsonXElement {
    /** A JSON object. Insertion order of [entries] is always preserved, there's no opt-out. */
